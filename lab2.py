...
def sum_(*args) -> float:
    ...
    Принимает любое количество аргументов (чисел) и возвращает их сумму.
    """
    if not args:  # Базовый случай: если аргументов нет, вернуть 0
        return 0
    return args[0] + sum_(*args[1:])  # Рекурсивно суммируем первый элемент с суммой остатка
print(sum_(1,2,3))
